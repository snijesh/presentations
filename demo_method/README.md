...
The 93 genes [*which may be overlapping with the filtered genes in the previous steps*] are appended to the final list of genes and given for functionall enrichment analysis<br>
